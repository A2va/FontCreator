...
public class FontExport {
	...
	public void exportFont(Font font) {
		...
		FileNameExtensionFilter filter = new FileNameExtensionFilter("Header files", "h");
	...
	public void exportToCHeader(Font font, File destination) {
		try {
			BufferedReader in = new BufferedReader(new InputStreamReader(new FileInputStream("font.template")));
			String template = "";
